...
def run_test_with_metrics(client, run_function, description, api_url, headers, project_id, log_stream_id, max_wait_time=120):
    """
    ...
    metrics = galileo_api.wait_for_metrics(api_url, headers, project_id, trace_id, target_metric="instruction_adherence")
    ...
    if not galileo_api.has_target_metric(metrics, "instruction_adherence"):
        ...
        metrics = galileo_api.wait_for_metrics(api_url, headers, project_id, trace_id, max_wait_time=max_wait_time * 1.5, target_metric="instruction_adherence")  # 50% longer timeout
