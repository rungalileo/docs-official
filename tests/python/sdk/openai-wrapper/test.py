...
This script tests the Galileo OpenAI wrapper by running the app.py script
...
def main():
    """Main function"""
    console.print(Panel(
        "[bold blue]Galileo OpenAI Wrapper Test[/]\n\n"
        "This script tests the Galileo OpenAI wrapper by running the app.py script\n"
        "and verifying that traces were created in the Galileo platform.",
    ...
    if success:
        ...
        console.print(Panel(
            ...
            "The Galileo OpenAI wrapper is working correctly.\n"
            "Traces were successfully created and contain spans for the OpenAI API call.",
        ...
        console.print(Panel(
            ...
            "The Galileo OpenAI wrapper may not be working correctly.\n"
