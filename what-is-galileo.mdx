...
<CardGroup cols={2}>
<Card title="Hello Galileo!" icon="code" horizontal href="/getting-started/hello-galileo">
     Already have Galileo configured? Here's the code to log your first trace.
</Card>
<Card title="Sign up" icon="circle-user" horizontal href="/getting-started/sign-up">
     Learn how to sign up for Galileo for free, integrate with an LLM to calculate metrics, and create projects.
</Card>
<Card title="Log and evaluate your first trace" icon="code" horizontal href="/getting-started/quickstart">
    Start logging traces and evaluating metrics for free with a few lines of code.
</Card>
