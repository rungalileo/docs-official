...
<CardGroup cols={2}>
<Card title="Hello Galileo!" icon="code" horizontal href="/getting-started/quickstart">
    Already have Galileo configured? Here's the code to log your first trace.
</Card>
<Card title="Log and evaluate your first trace" icon="code" horizontal href="/getting-started/log-and-evaluate-first-trace">
...
<Card title="Get started!" icon="code" horizontal href="/getting-started/log-and-evaluate-first-trace">
