...
Galileo is a cutting-edge evaluation and observability platform designed to empower developers, AI engineers, and eval engineers to improve their AI apps. Use our [Python](/sdk-api/python/sdk-reference) or [TypeScript](/sdk-api/typescript/sdk-reference) SDK, or [integrate with your favorite AI framework](/sdk-api/third-party-integrations/overview) to add evals directly into your code.
