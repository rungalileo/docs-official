---
title: Log Using OpenTelemetry and OpenInference
description: "This guide explains how to send OpenTelemetry (OTel) traces to Galileo using OpenInference"
---
...
headers = {
    ...
    "logstream": "<YOUR_RUN_NAME>",      # Must match the Log stream name
}
