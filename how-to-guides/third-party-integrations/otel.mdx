...
NOTE: If you're using a self-hosted or Galileo deployment other than app.galileo.ai, be sure to replace`app.galileo.ai` with your custom deployment URL.
...
- LangChain operations and OpenAI API calls are traced
