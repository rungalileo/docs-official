...
- [Run your application with OpenTelemetry](#running-your-application-with-opentelemetry)
...
- A free [Galileo account](https://app.galileo.ai/sign-up) account and [API key](https://app.galileo.ai/settings/api-keys)
