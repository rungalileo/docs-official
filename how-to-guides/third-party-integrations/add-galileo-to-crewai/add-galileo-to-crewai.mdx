...
1. [Load environment variables if necessary](#load-environment-variables-if-necessary)
1. [Add the Galileo event listener](#add-the-galileo-event-listener)
1. [Run your crew](#run-your-crew)
