...
For tool call examples and more details about decorating Steps, see [Decorate LLM and tool calls](https://docs.agentcontrol.dev/how-to/decorate-llm-tool-calls).
