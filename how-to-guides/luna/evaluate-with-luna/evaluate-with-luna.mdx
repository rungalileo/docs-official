...
1. [Create your AI application](#create-your-ai-application)
1. [Configure Luna-2 metrics](#configure-luna-2-metrics)
1. [Run your app again to evaluate these metrics](#run-your-app-again-to-evaluate-these-metrics)
1. [Adjust your prompt to increase toxicity and add a prompt injection](#adjust-your-prompt-to-increase-toxicity-and-add-a-prompt-injection)
...
![A trace with 0% for toxicity and a low prompt injection score](/how-to-guides/luna/evaluate-with-luna/metrics-no-toxicity-or-injection.webp)
...
![A trace with 99% toxicity and a high prompt injection score](/how-to-guides/luna/evaluate-with-luna/metrics-toxicity-and-injection.webp)
...
- [Fine-tune your own Luna metric in Luna Studio](/luna-studio/quickstart)
