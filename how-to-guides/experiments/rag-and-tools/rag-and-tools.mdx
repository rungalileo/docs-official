...
The core of this experiment is an application you can run to get a mock horoscope from a mocked RAG system, using Galileo logging to trace the LLM, tool, and RAG interactions. This core is then exposed to an experiment to show how you can take an existing application and run it through an experiment with a defined dataset of inputs.
