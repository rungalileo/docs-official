...
The core of this experiment is an application you can run to get a horoscope, using Galileo logging to trace the LLM, tool, and RAG interactions. This core is then exposed to an experiment to show how you can take an existing application and run it through an experiment with a defined dataset of inputs.
...
> You can find the code in this how-to guide in the [Galileo SDK examples repo](https://github.com/rungalileo/sdk-examples).
...
Update the OpenAI import to the following:
