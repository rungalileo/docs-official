...
import SnippetExperimentMainFunctionPythonBeta from "/snippets/code/python-beta/how-to-guides/experiments/rag-and-tools/experiment-main.mdx";
...
{/* <!-- markdownlint-disable MD051 MD037 --> */}
...
<CodeGroup>
  ...
  <SnippetExperimentMainFunctionPythonBeta />
  <SnippetExperimentMainFunctionTypeScript />
</CodeGroup>

This code runs the experiment, and calculates [tool error rate](/concepts/metrics/agentic/tool-error), [tool selection quality](/concepts/metrics/agentic/tool-selection-quality) and [context adherence](/concepts/metrics/rag/generation-quality/context-adherence).
