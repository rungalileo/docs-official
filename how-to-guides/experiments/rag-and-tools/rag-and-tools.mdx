...
The core of this experiment is an application you can run to get a mocked horoscope from a mocked RAG system, using Galileo logging to trace the LLM, tool, and RAG interactions. 
