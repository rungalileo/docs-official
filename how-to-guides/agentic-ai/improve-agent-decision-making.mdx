...
_Task:_ "Find the current stock price of Apple and summarize key financial trends."

**Agent Execution:**

1. Calls a weather API instead of a stock price API. _(Incorrect tool selection)_
2. Returns: "Apple’s stock is 80°F today\!" _(Tool error and faulty logic)_
