...
import SnippetImportCrewAIListener from "/snippets/code/python/how-to-guides/agentic-ai/crewai/import-crewai.mdx"
import SnippetCreateCrewAIListener from "/snippets/code/python/how-to-guides/agentic-ai/crewai/create-crewai.mdx"
import SnippetRunCrewAI from "/snippets/code/python/how-to-guides/agentic-ai/crewai/run-crewai.mdx"
...
Install the required dependencies for your app. Create a virtual environment using your preferred method, then install dependencies inside that environment using yur preferred tool:
...
![THe Galileo console showing a CrewAI trace with metrics](/how-to-guides/agentic-ai/add-galileo-to-crewai/logged-trace.webp)
