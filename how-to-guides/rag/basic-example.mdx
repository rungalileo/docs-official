...
<Screenshot description="Interface for setting up and configuring RAG implementation" placeholder="Add screenshot of RAG setup interface" />

{/* Screenshot: Retrieval Configuration */}

<Screenshot description="Panel showing retrieval configuration options and settings" placeholder="Add screenshot of retrieval configuration panel" />

{/* Screenshot: Results Visualization */}

<Screenshot description="Visualization of RAG results and retrieved content" placeholder="Add screenshot of results visualization" />

{/* Screenshot: Performance Metrics */}

<Screenshot description="Dashboard showing RAG performance metrics and analytics" placeholder="Add screenshot of performance metrics view" />
