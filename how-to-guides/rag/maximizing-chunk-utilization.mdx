...
1. **Dataset Loading**: We use the Hugging Face datasets library to load Wikipedia articles. The `num_docs` parameter controls how many articles to load, making it easy to start small for testing.
