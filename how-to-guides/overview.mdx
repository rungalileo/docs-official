...
<Columns>
<Card title="Basic OpenAI Integration" href="/how-to-guides/conversational-ai/basic-example" horizontal>
  Learn how to integrate and use OpenAI's API with Galileo's wrapper client.
  <br/>
  **Python**
</Card>

<Card title="Basic Async OpenAI Integration" href="/how-to-guides/conversational-ai/basic-async-openai-example" horizontal>
  Learn how to integrate and use OpenAI's Async API with Galileo.
  <br/>
  **Python**
</Card>
