...
From the email notification (example below), you can click on the <!-- vale Vale.Spelling = NO -->
"Open logstream"<!-- vale Vale.Spelling = YES --> link to open find the problematic traces.
...
1. Go to the "Incoming Webhooks" page of your Slack app, and enable the toggle to "Activate Incoming Webhooks".
