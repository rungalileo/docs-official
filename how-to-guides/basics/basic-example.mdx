...
<Note>
The Galileo OpenAI wrapper doesn't support the asynchronous API. See our [Basic Async OpenAI example](/how-to-guides/conversational-ai/basic-async-openai-example.mdx) for a guide on how to do this.
</Note>
