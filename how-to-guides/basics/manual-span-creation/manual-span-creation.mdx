...
import SnippetCodeWithTraceWithSpanPython from "/snippets/code/python/how-to-guides/basics/manual-span-creation/code-with-trace-with-span.mdx";
import SnippetCodeWithTraceWithSpanDetailedPython from "/snippets/code/python/how-to-guides/basics/manual-span-creation/code-with-trace-with-span-detailed.mdx";
...
import SnippetCodeWithTraceWithSpanTypeScript from "/snippets/code/typescript/how-to-guides/basics/manual-span-creation/code-with-trace-with-span.mdx";
import SnippetCodeWithTraceWithSpanDetailedTypeScript from "/snippets/code/typescript/how-to-guides/basics/manual-span-creation/code-with-trace-with-span-detailed.mdx";
...
1. [Create a new Galileo logger to log traces and spans to](#create-a-new-galileo-logger-to-log-traces-and-spans-to)
1. [Add spans](#add-spans)
1. [Add more details to the trace](#add-more-details-to-the-trace)
...
<Accordion title="View full code">
  <CodeGroup>
    <SnippetCodeWithTraceWithSpanPython />
    <SnippetCodeWithTraceWithSpanTypeScript />
  </CodeGroup>
</Accordion>
...
<Accordion title="View full code">
  <CodeGroup>
    <SnippetCodeWithTraceWithSpanDetailedPython />
    <SnippetCodeWithTraceWithSpanDetailedTypeScript />
  </CodeGroup>
</Accordion>
