...
**Dependencies**: PostgreSQL, Redis, ClickHouse, RabbitMQ, Object Storage
...
<Tabs>
  <Tab title="AWS">
    - **Compute**: EKS cluster with 3 node pools - **Database**: RDS Aurora
    PostgreSQL - **Cache**: ElastiCache Redis - **Storage**: S3 buckets -
...
<Tab title="Google Cloud">
  ...
  PostgreSQL - **Cache**: Memorystore for Redis - **Storage**: Cloud Storage
  buckets - **Ingress**: GKE Ingress or NGINX
</Tab>

  <Tab title="Azure">
    - **Compute**: AKS cluster with 3 node pools - **Database**: Azure Database
    for PostgreSQL - **Cache**: Azure Cache for Redis - **Storage**: Azure Blob
    Storage - **Ingress**: Application Gateway or NGINX
  </Tab>
</Tabs>
...
- Application logs stored in ClickHouse

### Tracing

- Distributed tracing for request flows
- Performance monitoring via APM tools
- Custom trace storage in ClickHouse
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="shield-check"
    href="/deployment-docs/security-considerations"
  >
