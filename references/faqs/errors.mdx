...
{/* Use a full href as the broken link checker can't cope with links to generated API docs */}
Find solutions to errors with the <a href="https://v2docs.galileo.ai/api-reference/">Galileo API</a> below.
...
- **Troubleshooting**:
  - Validate your JSON payload structure.
    {/* Use a full href as the broken link checker can't cope with links to generated API docs */}
  - Review the <a href="https://v2docs.galileo.ai/api-reference/">API documentation</a> for required fields.
...
- **Troubleshooting**:
  {/* Use a full href as the broken link checker can't cope with links to generated API docs */}
  - Consult the <a href="https://v2docs.galileo.ai/api-reference/">API documentation</a> to confirm the correct method (`GET`, `POST`, `PUT`, `DELETE`).
