...
Galileo uses structured error codes to help you quickly identify and resolve issues. Each error includes a unique code, severity level, and recommended user action.
...
Use the search box to quickly find errors by code, type, message, or user action.
You can also link directly to a specific error row with the URL hash format `#error-<code>`.
For example: `https://docs.galileo.ai/references/faqs/errors-catalog#error-8000`.
