...
Galileo uses structured error codes to help you quickly identify and resolve issues.

## On this page

- [Error Locator](https://docs.galileo.ai/references/faqs/errors-catalog#error-locator)
- [Error Code Ranges](https://docs.galileo.ai/references/faqs/errors-catalog#error-code-ranges)
- [Severity Levels](https://docs.galileo.ai/references/faqs/errors-catalog#severity-levels)
- [Need Help?](https://docs.galileo.ai/references/faqs/errors-catalog#need-help)

Each error includes a unique [code](#error-code-ranges), [severity level](#severity-levels), and recommended user action.
