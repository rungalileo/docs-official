...
- Metrics may appear to be missing because they do not apply to Log streams. With Log streams, no [Ground Truths](/concepts/metrics/rag/generation-quality/ground-truth-adherence) are provided.
