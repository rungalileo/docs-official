...
- **Automatic and custom metrics**: Evaluate and track instruction adherence, correctness, safety & compliance, and more.
...
Built-in metrics work best when reference outputs are provided in the same language. You can also log custom metrics specific to a language or region to reflect accuracy or appropriateness.
