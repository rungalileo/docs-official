...
Traces in Galileo are collections of related [Spans](/concepts/spans) that represent complete interactions or workflows in your AI application. They provide a holistic view of how your application processes requests, from initial input to final output, capturing all the intermediate steps along the way.
