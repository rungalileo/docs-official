...
The Luna-2 model works with most of the [out of the box metrics](/sdk-api/metrics/metrics#luna-metrics), or your [LLM as a judge custom metrics](http://localhost:3000/concepts/metrics/custom-metrics/custom-metrics-ui-llm).
