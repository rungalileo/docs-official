...
- **Read-only** (enterprise only) – Cannot create, update, share, or delete any projects or resources. Limited to view-only permissions.

_Note:_ Free users of Galileo can only use the Admin or user roles. [Contact us](https://galileo.ai/contact-sales) to explore a paid plan and get full RBAC. 
...
## Share Projects (paid plans only)

By default, only a project's creator (and managers and admins) have access to a project. Projects can be shared both with individual users and entire groups. Together, these are called _collaborators_. Collaborators can be added when you create a project:

![Image shows how to create a project with collaborators in Galileo](/images/access-control-2.png)
