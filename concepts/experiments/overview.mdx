...
{/* The getting-started/experiments is a pure copy of this file until it gets re-written as a proper getting started. Any changes here should be copied there until that is re-written. Upon re-writing, delete this comment */}
...
<Steps>
  ...
  <Step title="Expanding Test Coverage">
    ...
    - Use Galileo's [datasets](/concepts/experiments/datasets) to organize and maintain test cases
    - Or bring your own dataset if you already have test data
    - Run experiments [through the Galileo console](/concepts/experiments/running-experiments-in-console) or [in code](/concepts/experiments/running-experiments) to look for patterns in how your application handles different types of inputs
  ...
  <Step title="Finding and Fixing Issues">
    ...
    - Add these inputs to a [datasets](/concepts/experiments/datasets)
...
## Next Steps
<Card title="Create a Dataset" icon="box" href="/concepts/experiments/datasets" horizontal>
...
<Card title="Run an Experiment with Code" icon="lightbulb" href="/concepts/experiments/running-experiments" horizontal>
