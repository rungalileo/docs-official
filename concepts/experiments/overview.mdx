...
<CardGroup cols={2}>
<Card title="Run Experiments in the Galileo Console" icon="play" horizontal href="/sdk-api/experiments/experiments">
...
<Card title="Run an Experiment in the Console" icon="play" href="/concepts/experiments/running-experiments-in-console" horizontal>
