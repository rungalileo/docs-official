...
import SnippetDatasetsCreatePython from '/snippets/code/python/concepts/experiments/datasets/create.mdx';
import SnippetDatasetsCreateTypescript from '/snippets/code/typescript/concepts/experiments/datasets/create.mdx';
import SnippetDatasetsAddSamplesPython from '/snippets/code/python/concepts/experiments/datasets/add-samples.mdx';
import SnippetDatasetsAddSamplesTypescript from '/snippets/code/typescript/concepts/experiments/datasets/add-samples.mdx';
import SnippetDatasetsVersionsPython from '/snippets/code/python/concepts/experiments/datasets/versions.mdx';
import SnippetDatasetsVersionsTypescript from '/snippets/code/typescript/concepts/experiments/datasets/versions.mdx';
...
![Creating a new dataset in Galileo's interface](/images/dataset-create-button.png)

The dataset creation button, shown above, is your starting point for organizing test cases in Galileo's interface.

![Dataset configuration dialog](/images/dataset-dialog.png)
...
![Manual sample creation in a dataset](/images/console-ui/dataset-create.png)
...
- **NOTE:** Columns in datasets may only include "input", "output", and "metadata" to be usable in an [Experiment](/concepts/experiments). The JSON-formatted [metadata](/concepts/experiments) column is ideal for including additional data about the experiment.

### Saving Changes and Creating Versions

![Saving changes to your dataset](/images/dataset-save-button.png)
...
![Viewing version history of a dataset](/images/dataset-versions.png)
...
<CodeGroup>
<SnippetDatasetsCreatePython />
<SnippetDatasetsCreateTypescript />
</CodeGroup>
...
<CodeGroup>
<SnippetDatasetsAddSamplesPython />
<SnippetDatasetsAddSamplesTypescript />
</CodeGroup>
...
<CodeGroup>
<SnippetDatasetsVersionsPython />
<SnippetDatasetsVersionsTypescript />
</CodeGroup>
