...
Galileo's model pricing allows admins to configure model prices that will be used to calculate app and metric costs. Other organization users can view model pricing in read-only mode. With this feature, teams have more accurate views of how their AI agents are impacting budgets.
