...
Galileo's model pricing allows admins to configure model prices that will be used to calculate app and metric costs. All organization users can view model pricing in read-only mode, so teams have a more accurate view of how their AI agents are impacting budgets.
