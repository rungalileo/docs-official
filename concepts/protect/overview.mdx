...
description: Learn the concepts behind runtime guardrails to safeguard applications with runtime monitoring using Luna-2 or custom code based metrics
---

Galileo provides runtime guardrails for your AI applications, checking inputs to, and outputs from LLMs against a range of metrics, allowing you to block user actions, or respond differently to the user.

With runtime guardrails you can protect your system and your users from:
...
<CardGroup cols={2}>
<Card title="Runtime guardrail SDK reference" icon="code" horizontal href="/sdk-api/protect/protect">
    Learn how to add runtime guardrails to your applications.
</Card>
...
You can add guardrails to your application, checking either the inputs to, or outputs from an LLM against metrics, either using Luna-2, or custom code based metrics. These checks are defined as **rules**, which are grouped into **rulesets**, which in turn are grouped into **stages** that can be run at different stages in the workflow of your application.
...
## Components of a runtime guardrail

To invoke runtime guardrails, you need to configure a number of components - rules, actions, rulesets, and stages.
...
<Card title="Contact us to enable Luna-2" icon="comment" horizontal href="https://galileo.ai/contact-sales">
    Contact us to learn more about using Luna-2 with runtime guardrails.
</Card>
</CardGroup>