...
Protect is deprecated as of June 2026. We don't recommend setting it up as a new solution. To safeguard your AI applications, set up [Agent Control](/concepts/agent-control/overview) instead.
