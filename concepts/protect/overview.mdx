...
description: Learn the concepts behind Galileo Protect to safeguard applications with runtime monitoring using Luna-2 or custom code based metrics
---

Galileo Protect provides runtime guardrails for your AI applications, checking inputs to, and outputs from LLMs against a range of metrics, allowing you to block user actions, or respond differently to the user.
...
<Card title="Protect SDK reference" icon="code" horizontal href="/sdk-api/protect/protect">
    Learn how to add runtime guardrails to your applications with Galileo Protect.
</Card>
</CardGroup>
