...
Galileo provides runtime protection for your AI applications, checking inputs to, and outputs from LLMs against a range of metrics, allowing you to block user actions, or respond differently to the user.

With runtime protection you can protect your system and your users from:
