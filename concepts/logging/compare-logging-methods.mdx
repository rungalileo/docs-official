...
When building a Generative AI application, it is crucial to understand its behavior: what data is processed, where errors occur, and how long responses take. Galileo solves this by provides OpenAI ([TypeScript](/sdk-api/typescript/wrappers/openai), [Python](/sdk-api/python/wrappers/openai)) and LangChain ([Python](/sdk-api/python/wrappers/langchain)) wrappers, which help you generate application traces with minimal set up.
