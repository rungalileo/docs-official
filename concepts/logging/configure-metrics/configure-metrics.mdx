...
Commented out till https://app.shortcut.com/galileo/story/38771/metric-sampling-doesn-t-work-with-metadata-rules is fixed
...
Commented out till https://app.shortcut.com/galileo/story/38814 is fixed
...
You can filter the spans that a metric is calculated for, based off the span name or span metadata. Metric filtering is configured at a Log stream level.
...
Use the **Add Condition** button to add a condition based off a span name, or span metadata.
