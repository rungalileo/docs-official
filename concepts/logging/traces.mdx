...
import SnippetPythonOpenAIWrapper from '/snippets/code/python/concepts/logging/traces/openai-wrapper.mdx'
import SnippetTSOpenAIWrapper from '/snippets/code/typescript/concepts/logging/traces/openai-wrapper.mdx'
import SnippetPythonDecorator from '/snippets/code/python/concepts/logging/traces/decorator.mdx'
import SnippetTSObserver from '/snippets/code/typescript/concepts/logging/traces/observer.mdx'
import SnippetPythonBasicTrace from '/snippets/code/python/concepts/logging/traces/basic-trace.mdx'
import SnippetTSBasicTrace from '/snippets/code/typescript/concepts/logging/traces/basic-trace.mdx'
import SnippetPythonComplexWorkflow from '/snippets/code/python/concepts/logging/traces/complex-workflow.mdx'
import SnippetTSComplexWorkflow from '/snippets/code/typescript/concepts/logging/traces/complex-workflow.mdx'
import SnippetPythonChatApplication from '/snippets/code/python/concepts/logging/traces/chat-application.mdx'
import SnippetTSChatApplication from '/snippets/code/typescript/concepts/logging/traces/chat-application.mdx'

Traces in Galileo are collections of related [Spans](/concepts/logging/spans) that represent complete interactions or workflows in your AI application. They provide a holistic view of how your application processes requests, from initial input to final output, capturing all the intermediate steps along the way.
...
- [Log Streams](/concepts/logging/logstreams) - Explore how to organize traces into streams
