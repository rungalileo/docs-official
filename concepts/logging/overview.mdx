...
{/* The getting-started/logging is a pure copy of this file until it gets re-written as a proper getting started. Any changes here should be copied there until that is re-written. Upon re-writing, delete this comment */}
...
[Log streams](/concepts/logging/logstreams) ​are organizational units that group related traces together based on logical deployments, applications, or environments.
