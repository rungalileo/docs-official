...
<Steps>
    ...
    <Step title="Log in to the Galileo Console and select your Log Stream">
        ...
        <Frame>
        ![Select your Log Stream](/images/concepts/logging/session--select-logstream.png)
        </Frame>
    </Step>
    ...
    <Step title="Select your session">
        ...
        <Frame>
        ![Group or ungroup log events](/images/concepts/logging/session--event-toggle.webp)
        </Frame>
    ...
    <Step title="View your session">
        ...
        <Frame>
        ![Group or ungroup log events](/images/concepts/logging/session--trace-detail.webp)
        </Frame>
    </Step>

    <Step title="Optional: View Chat Messages">
        You can also view the questions and answers that resulted from the chat session. Just select the **Messages** tab (shown in the image below) to see a list of traces in the session, along with their child spans. Each message from the user and response from the LLM will form a single trace; you can view the contents here in a familiar format.
