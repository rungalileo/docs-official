...
<Steps>
    ...
    <Step title="Add your LLM logic">
        Now you can interact with your LLM. Our very simple application will invoke the LLM with a single question, and then conclude the logging session. We will also pass a callback handler, which is a function that gets called by `LangChain` after the LLM has been invoked. You can add as much complexity as you like to this part. 
