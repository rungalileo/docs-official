...
- Debug failures with full input context
...
[Out-of-the-box multimodal metrics →](/concepts/metrics/multimodal-quality/multimodal-quality-overview)
...
3. Configure a model integration. See [recommended models](#supported-formats-and-models) below.
