...
- [Tool Error Examples](https://app.galileo.ai) - Log in and explore the "Tool Error" logstream in the "Preset Metric Examples" project to see this metric in action
