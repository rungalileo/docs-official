...
<Scale
  low="0"
  lowLabel="High Error Rate"
  high="1"
  highLabel="Low Error Rate"
  lowDescription="Many tools failed during execution, causing incomplete or incorrect responses."
  midDescription="Some tools executed correctly while others encountered errors."
  highDescription="All tools executed correctly without errors."
/>
...
We evaluated Tool Error against human expert labels on an internal dataset of agentic conversation samples using top frontier models.

| Model | F1 (Error) |
|:------|:--------:|
| GPT-4.1 | 0.88 |
| GPT-4.1-mini (judges=3) | 0.96 |
| Claude 4.5 Sonnet | 0.94 |
| Gemini 3 Flash | 0.94 |
...
<BooleanClassificationReport
  report={`
       ...
       False     0.9860    0.9810    0.9835       791
        True     0.8684    0.9000    0.8839       110

    accuracy                         0.9711       901
   macro avg     0.9272    0.9405    0.9337       901
weighted avg     0.9717    0.9711    0.9714       901
  `}
  negativeLabel="No Error"
  positiveLabel="Error"
  negativeClass="False"
  positiveClass="True"
/>
...
- [Tool Error Examples](https://app.galileo.ai) - Log in and explore the "Tool Error" Log Stream in the "Preset Metric Examples" Project to see this metric in action
