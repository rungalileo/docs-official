...
Reasoning Coherence — A binary metric that evaluates internal logical consistency within a single LLM call, with respect to the latest user input and any attached content.
...
- Latest user input, current system prompt, and attached content when present
