...
<Steps>
  ...
  <Step title="Score Calculation">The final score is computed by converting the binary decisions into a 0–100 confidence (e.g., percentage of positive judgments).</Step>
</Steps>
