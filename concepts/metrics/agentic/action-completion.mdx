...
<DefinitionCard>
  <strong>Action Completion</strong> measures whether or not the agent is truly useful at accomplishing a user's goals. 
</DefinitionCard>
...
Action Completion is successful when:
...
| **Can be applied to** | Agent, Session |
...
Implement Action Completion monitoring to ensure your agent consistently accomplishes user goals and provides complete, accurate responses.
...
Use Action Completion alongside other agentic metrics, such as [Action Advancement](/concepts/metrics/agentic/action-advancement), to get a comprehensive view of your assistant's effectiveness and identify areas for improvement.
...
- [Tool Selection](/concepts/metrics/agentic/tool-selection)
- [Agentic AI Overview](/concepts/agentic-ai)
