...
weighted avg     0.9336    0.9333    0.9333       150
  `}
  negativeLabel="Flow Not Satisfied"
  positiveLabel="Flow Satisfied"
  negativeClass="False"
  positiveClass="True"
/>
...
- [Agent Flow Examples](https://app.galileo.ai) - Log in and explore the "Agent Flow" Log stream in the "Preset Metric Examples" Project to see this metric in action.
