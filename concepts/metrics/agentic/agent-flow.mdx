...
- [Agent Flow Examples](https://app.galileo.ai) - Log in and explore the "Agent Flow" logstream in the "Preset Metric Examples" project to see this metric in action
