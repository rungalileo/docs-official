...
This article explains the Action Advancement metric and how it works inside of Galileo.
...
By implementing Action Advancement, you can gain clear insights into whether your AI agents are making meaningful progress toward user goals rather than just providing responses.
...
| **Can be applied to** | agent, session, trace, + span |
...
Action Advancement is particularly helpful when evaluating AI agents in these scenarios:
...
TODO: test, add and update code snippets in Python + TypeScript
...
TODO: Double check LLM/Luna Support + Protect Support
TODO: Define differences between goal progress/advancement v. action advancement
...
TODO: Test, update, and add basic implementation notes (no arguments/default callbacks) in typescript/python
