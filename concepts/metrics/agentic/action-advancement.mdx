...
<Card>
  ...
  Action Advancement is particularly valuable for evaluating complex, multi-step interactions where progress toward goals matters more than individual response quality. This metric shines when simple response quality metrics fall short.
