...
For a practical guide to creating your own LLM-as-judge metrics, see [Custom LLM-as-judge metrics](/concepts/metrics/custom-metrics/custom-metrics-ui-llm). To learn about code-based custom metrics, see [Custom Code-Based Metrics](/concepts/metrics/custom-metrics/custom-metrics-ui-code).
...
- [Custom LLM-as-judge metrics](/concepts/metrics/custom-metrics/custom-metrics-ui-llm) - Create your own evaluation metrics
