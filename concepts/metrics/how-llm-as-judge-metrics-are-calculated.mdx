...
**Examples:** [Response Quality Metrics](/concepts/metrics/response-quality/response-quality-overview)
...
Effective evaluation prompts should be specific by clearly defining what you're measuring and how to measure it, include examples to provide sample evaluations that guide the model, request reasoning to ensure thoughtful assessment, and set boundaries by defining acceptable score ranges and criteria. For more guidance on prompt engineering, see [Prompt Templates](/sdk-api/experiments/prompts) and [Optimizing Prompts](/cookbooks/features/prompts/optimizing-prompts).
