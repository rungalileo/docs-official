---
title: Chunk Relevance (Deprecated)
description: Understand how to measure and optimize the relevance of retrieved chunks to user queries in your RAG pipeline (deprecated - use Chunk Relevance instead)
---
...
This deprecated metric identifies whether a retrieved chunk contains useful information for the user's query. A chunk with low relevance contains "unnecessary" text that is not pertinent to the user's query, indicating potential inefficiencies in your retrieval strategy.
