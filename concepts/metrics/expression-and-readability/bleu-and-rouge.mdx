...
<Note>
BLEU and ROUGE are only supported in experiments, and require a Ground Truth to be set in the `output` column of your experiment's [dataset](/concepts/datasets).
</Note>
