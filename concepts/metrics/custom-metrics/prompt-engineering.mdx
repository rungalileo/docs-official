...
For maximum clarity and model control, we structure prompts using a consistent, modular format. A prompt has 4 sections, one of which you provide when you create the LLM-as-a-judge metric, the others are created by Galileo, and described here for information only.
