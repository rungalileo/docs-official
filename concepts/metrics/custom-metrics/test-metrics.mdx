...
<CardGroup cols={2}>
  ...
  <Card title="Catch drift early" icon="triangle-exclamation">
    Run it again after a model upgrade or API change. If the macro F1 score drops, you know the metric needs attention before it affects your evaluations.
  </Card>
</CardGroup>
