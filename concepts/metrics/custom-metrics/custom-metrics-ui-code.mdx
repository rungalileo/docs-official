...
Select the model you want to use for code generation from the dropdown. Models recommended for code generation are highlighted.
</Step>
<Step title="Click Generate">
Click **Generate**. The scorer function is written directly into the editor. Review it, adjust if needed, and proceed to test and save as normal.
</Step>
</Steps>
...
```
The metric should calculate the edit distance between the ground truth and the generated output.
