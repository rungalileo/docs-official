...
<Card title="Create custom LLM-as-a-judge metrics" icon="code" horizontal href="/concepts/metrics/custom-metrics/custom-metrics-ui-code">
    Learn how to create custom LLM-as-a-judge metrics in the Galileo console.
</Card>
<Card title="Create custom LLM-as-a-judge metrics in code" icon="code" horizontal href="/sdk-api/metrics/create-custom-llm-metrics">
    Learn how to create custom LLM-as-a-judge metrics in code.
</Card>
