...
Registered custom metrics run in a sandboxed Python 3.10 environment with only
the Python standard library and 'Galileo' installed.

To install your own pypi package, you can define dependencies at the top of the
file using the scrip dependency format from 'uv':
