...
<Card>
  <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem'}}>
    ...
    <h3 style={{margin: 0, fontSize: '1.25rem', fontWeight: '600'}}>Improving Prompt Perplexity</h3>
  </div>
  
  To achieve lower perplexity scores and better model performance:
      
  <div style={{marginTop: '1rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(209, 213, 219, 0.33)'}}>
    <strong>Use familiar language patterns:</strong> Phrase prompts using language patterns similar to the model's training data.
  </div>
  
  <div style={{marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(209, 213, 219, 0.33)'}}>
    <strong>Provide clear context:</strong> Include sufficient context that helps the model predict what comes next.
  </div>
  
  <div style={{marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(209, 213, 219, 0.33)'}}>
    <strong>Avoid unusual formatting:</strong> Use standard formatting and avoid unusual syntax that might confuse the model.
  </div>
  
  <div style={{marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(209, 213, 219, 0.33)'}}>
    <strong>Test variations:</strong> Experiment with different phrasings of the same prompt to find lower perplexity versions.
  </div>
</Card>
