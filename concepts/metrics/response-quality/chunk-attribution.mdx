...
Chunk Attribution Utilization is a dual metric that calculates 2 values - [chunk attribution](#chunk-attribution) and [chunk utilization](#chunk-utilization).
...
<Card title="Balance with Other Metrics" icon="scale-balanced">
    Use Chunk Attribution Utilization alongside [Chunk Relevance](/concepts/metrics/response-quality/chunk-relevance) for a complete picture of retrieval effectiveness.
</Card>
