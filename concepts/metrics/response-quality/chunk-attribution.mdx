...
<Card>
  ...
  <div style={{marginTop: '1rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(209, 213, 219, 0.33)'}}>
    <strong>Attribution analysis:</strong> Chunks 1 and 3 would be <Pill label="Attributed" /> because information from them appears in the response. Chunk 2 would be <Pill label="Not Attributed" /> because it contains information about black tea, which wasn't included in the response.
  </div>
</Card>
