...
<Note>
This metric requires a Ground Truth to be set. Check out [this page](/getting-started/experiments/running-experiments-in-console) to learn how to add a Ground Truth to your runs.
</Note>
