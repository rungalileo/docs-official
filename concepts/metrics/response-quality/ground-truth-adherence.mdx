...
<Steps>
  <Step title="Sending additional requests to OpenAI's GPT4o" />
  <Step title="Using a carefully engineered chain-of-thought prompt that asks the model to judge whether the Ground Truth and Response are semantically equivalent" />
