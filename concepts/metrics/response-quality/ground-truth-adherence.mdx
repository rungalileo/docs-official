...
<Note>
This metric is only supported in experiments, and requires a Ground Truth to be set in the `output` column of your experiment's [dataset](/concepts/datasets).
</Note>
