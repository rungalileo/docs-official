...
- [Ground Truth Adherence Examples](https://app.galileo.ai) - Log in and explore the "Ground Truth Adherence" logstream in the "Preset Metric Examples" project to see this metric in action
