...
- [Ground Truth Adherence Examples](https://app.galileo.ai) - Log in and explore the "Ground Truth Adherence" Log stream in the "Preset Metric Examples" Project to see this metric in action.
