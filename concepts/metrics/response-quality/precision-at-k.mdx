...
<Note type="info">
  Precision @ K is differentiated from [Context Precision](/concepts/metrics/response-quality/context-precision): Precision @ K evaluates precision at a specific rank K and helps assess ranking quality, while Context Precision considers all retrieved chunks to measure noise in retrieval.
</Note>
