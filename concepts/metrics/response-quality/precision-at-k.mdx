...
This metric helps evaluate retrieval quality at specific rank positions and determine the optimal number of chunks to retrieve (Top K). Unlike [Context Precision](/concepts/metrics/response-quality/context-precision), Precision @ K focuses on a specific rank K and does not use position weighting.
