...
weighted avg     0.8950    0.8950    0.8950      1000
  `}
  negativeLabel="Not Adherent"
  positiveLabel="Adherent"
  negativeClass="False"
  positiveClass="True"
/>
...
- [Context Adherence Examples](https://app.galileo.ai) - Log in and explore the "Context Adherence" logstream in the "Preset Metric Examples" project to see this metric in action
