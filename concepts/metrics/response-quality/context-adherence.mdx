...
_Context Adherence Luna_ is computed using Galileo in-house small language models (Luna). Context Adherence Luna is a cost-effective way to scale up your RAG evaluation workflows.

To leverage Luna for context adherence or other metrics, [reach out to our team](https://galileo.ai/contact-sales).
