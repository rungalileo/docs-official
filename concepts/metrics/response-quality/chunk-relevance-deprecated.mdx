...
<CardGroup cols={2}>
  ...
  <Card title="Combine with Other Metrics" icon="scale-balanced">
    Use Chunk Relevance alongside [Chunk Attribution Utilization](/concepts/metrics/response-quality/chunk-attribution) for a complete picture of retrieval effectiveness.
