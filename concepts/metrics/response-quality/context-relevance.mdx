...
- [Context Relevance Examples](https://app.galileo.ai) - Log in and explore the "Context Relevance" logstream in the "Preset Metric Examples" project to see this metric in action
