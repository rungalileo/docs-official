...
- [PII / CPNI / PHI](/concepts/metrics/safety-and-compliance/pii) for LLM-as-a-judge
- [Prompt Injection](/concepts/metrics/safety-and-compliance/prompt-injection)
- [Sexism / Bias](/concepts/metrics/safety-and-compliance/sexism) for LLM-as-a-judge
- [Tone](/concepts/metrics/expression-and-readability/tone) for LLM-as-a-judge
- [Toxicity](/concepts/metrics/safety-and-compliance/toxicity) for LLM-as-a-judge
</Accordion>
...
- [PII / CPNI / PHI](/concepts/metrics/safety-and-compliance/pii) when using Luna-2
- [Prompt Perplexity](/concepts/metrics/model-confidence/prompt-perplexity)
- [Sexism / Bias](/concepts/metrics/safety-and-compliance/sexism) when using Luna-2
- [Tone](/concepts/metrics/expression-and-readability/tone) when using Luna-2
- [Tool selection quality](/concepts/metrics/agentic/tool-selection-quality)
- [Toxicity](/concepts/metrics/safety-and-compliance/toxicity) when using Luna-2
