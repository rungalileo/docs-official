...
<CardGroup cols={3}>
  <Card title="Response Quality" href="#response-quality-metrics">
...
## Expression & Readability Metrics
...
<CardGroup cols={2}>
  <Card title="Explore Response Quality" href="/concepts/metrics/response-quality/completeness">
    Dive deeper into metrics for evaluating response quality.
  </Card>
  <Card title="Implement Guardrails" href="/concepts/guardrails/overview">
    Learn how to use metrics to create effective guardrails.
  </Card>
</CardGroup>
