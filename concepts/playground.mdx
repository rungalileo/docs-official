...
The Playground works seamlessly with other Galileo features like [Experiments](/concepts/experiments/overview) for more structured testing, [Metrics](/concepts/metrics) for performance evaluation, and [Datasets](/concepts/experiments/datasets) for testing against diverse inputs. Use the navigation bar at the top to switch between these features as needed.
