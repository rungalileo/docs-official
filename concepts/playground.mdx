...
<Screenshot 
    alt="The Galileo Playground"
    imageUrl="/screenshots/playground.png"
    caption="The Galileo Playground"
/>
...
<Screenshot
    alt="Variables in the Playground"
    imageUrl="/screenshots/playground-with-variable.png"
    caption="Variables in the Playground"
/>
...
The Playground works seamlessly with other Galileo features like **Experiments** for more structured testing, **Metrics** for performance evaluation, and **Datasets** for testing against diverse inputs. Use the navigation bar at the top to switch between these features as needed.
