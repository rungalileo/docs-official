...
<Note>
  AI Assistant responses are AI-generated and can be incomplete or incorrect, so verify anything you act on. The feature set is still evolving, and behavior may change.
</Note>
