...
| **Get a fix** | "What should I do next to fix the issues found by my metrics?" · "How should I modify my prompt to fix this issue?" · "What should I do next to improve my agent based on the metric results?" |
| **Find similar traces** | "Show me traces similar to this one where hallucination occurred." · "Show me all traces where chunk relevance was low." · "Show me sessions where the user escalated or asked the same question twice." |
| **Spot patterns across a Log stream** | "What are the top failure patterns this week?" · "What categories of queries are underperforming?" · "Which types of queries are failing the most right now?" |
