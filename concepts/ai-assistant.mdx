...
| **Find similar traces** | "Show me traces similar to this one where the model hallucinated." · "Show me all traces where chunk relevance was low." · "Show me sessions where the user escalated or asked the same question twice." |
