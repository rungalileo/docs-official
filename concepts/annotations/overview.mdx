...
* Case‑sensitive strings ≤ 50 chars each (v2docs.galileo.ai)
...
To add annotations to your [Traces](/concepts/traces), initialize the Galileo Logger, and then include tags and metadata when you start your Trace.
...
Attach annotations to your [Spans](/concepts/spans) by including tags and metadata when you add your Span.
...
* Tag early. Start the trace yourself and pass tags before the first LLM call; otherwise auto‑spans may end up in an untagged trace. (v2docs.galileo.ai)
