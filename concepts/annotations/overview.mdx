...
You can see the tags and metadata in the [Log Streams](/sdk-api/logging/logging-basics) section of the [Galileo Console](https://app.galileo.ai/).
...
To add annotations to your [Traces](/sdk-api/logging/galileo-logger#start-a-trace), initialize the Galileo Logger, and then include tags and metadata when you start your Trace.
...
Attach annotations to your [Spans](/sdk-api/logging/galileo-logger#add-spans) by including tags and metadata when you add your Span.
