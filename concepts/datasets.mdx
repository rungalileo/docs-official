...
You can also customize the generated data:
  ...
  - Change the number of rows that you ask the LLM to generate.
  - Change the LLM model that you're utilizing.
  ...
  - **Generated Data Types** (Optional): Customize data types that the generated data should follow.
