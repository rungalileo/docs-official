...
Autotune aggregates that feedback and automatically adapts the metric prompt with full visibility into changes. To autotune, hover over any LLM-as-a-judge metric and click "Add feedback".

To learn more, see [Autotune](https://v2docs.galileo.ai/concepts/metrics/autotune-llm-as-a-judge-metrics).
