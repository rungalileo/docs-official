...
<Update label="2025-08-22" description="Enhanced SDK, CrewAI Integration, and Agent Insights Improvements">

### Key new features and improvements

#### Updates and improvements to CrewAI integration

Galileo's [integration with CrewAI](/how-to-guides/third-party-integrations/add-galileo-to-crewai/add-galileo-to-crewai) has been improved to provide better observability and debugging capabilities for multi-agent workflows. The enhanced integration now offers improved logging, metrics tracking, and session management for complex agent interactions.

#### SDK improvements and deprecation updates

**[Deprecated method update](sdk-api/python/reference/prompts.mdx) for prompts in the Python SDK**: The `create_prompt_template` method has been deprecated in favor of `create_prompt` for better clarity and consistency. This change improves the API design while maintaining backward compatibility during the transition period.
...
Galileo now supports [synthetic dataset generation](/concepts/datasets#synthetic-data-generation), allowing you to create training and evaluation datasets programmatically. This feature enables you to generate diverse, controlled datasets for testing your AI applications without manual data collection.
...
#### Agent Insights performance improvements
The Agent Insights feature has been optimized for better performance and user experience:
...
Apply these metrics at [span](/concepts/logging/spans#spans), [trace](/concepts/logging/traces#traces), or [session levels](/getting-started/logging#sessions), or create agentic metrics to evaluate complete workflows.
