...
### Safeguard AI applications with Agent Control

Agent Control provides a centralized layer for evaluating LLM and tool inputs and outputs during agent workflow execution. It helps block harmful content, prompt injection, PII leakage, and other risks without requiring changes to agent code. Use Agent Control to define guardrails and manage agent governance from one central place.
