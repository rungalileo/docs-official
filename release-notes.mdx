...
Galileo now supports [synthetic data generation](/concepts/datasets#synthetic-data-generation), allowing you to create training and evaluation datasets programmatically. This feature enables you to generate diverse, controlled datasets for testing your AI applications without manual data collection.
