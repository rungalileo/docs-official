...
- [Reasoning Coherence](/concepts/metrics/agentic/reasoning-coherence)
- [Input/Output Toxicity](/concepts/metrics/safety-and-compliance/toxicity)
- [User Intent Change](/concepts/metrics/agentic/intent-change)
