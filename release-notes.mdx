...
You can now [create alerts](/how-to-guides/basics/set-up-alerts-on-logs) using the **Trace Count** system metric. Get notified when traces are ingested at a higher or lower rate than expected within a specified time period.
