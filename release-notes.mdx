...
Galileo now supports configuring AWS Bedrock integrations using the
`inference_profiles` property. This enhancement allows customers
...
Galileo supports the following authentication
methods for AWS Bedrock integrations:

- Assumed IAM Role (Recommended)
- AWS Access Key / Secret Access Key

The script below demonstrates how to configure an AWS Bedrock integration in Galileo.
It is a setup script that tells Galileo how to authenticate to AWS
and which Bedrock models map to which inference profiles.
...
# You can use either model alias or model name,
# and map it to an inference profile ARN.
...
if [ -z "$GALILEO_API_URL" ]; then
  ...
  echo "Example: export GALILEO_API_URL=https://api-galileo.example.com"
  exit 1
fi
  ...
  --data-raw "$(cat <<EOF
{
  ...
  "inference_profiles": {
    "Anthropic - Claude 3.5 Sonnet (Bedrock)": "arn:aws:bedrock:us-east-1:818240400754:application-inference-profile/example1",
    "anthropic.claude-sonnet-4-20250514-v1:0": "arn:aws:bedrock:us-east-1:818240400754:application-inference-profile/example2"
  }
}
EOF
)"
...
# -----------------------------------------------|------------------------------------------
# AWS - Titan TG1 Large (Bedrock)                | amazon.titan-tg1-large
# AWS - Titan Lite v1 (Bedrock)                  | amazon.titan-text-lite-v1
# AWS - Titan Express v1 (Bedrock)               | amazon.titan-text-express-v1
# Cohere - Command v14 (Bedrock)                 | cohere.command-text-v14
# Cohere - Command Light v14 (Bedrock)           | cohere.command-light-text-v14
# Cohere - Command R v1 (Bedrock)                | cohere.command-r-v1:0
# Cohere - Command R+ v1 (Bedrock)               | cohere.command-r-plus-v1:0
...
# Anthropic - Claude 3 Sonnet (Bedrock)          | anthropic.claude-3-sonnet-20240229-v1:0
# Anthropic - Claude 3 Haiku (Bedrock)           | anthropic.claude-3-haiku-20240307-v1:0
# Anthropic - Claude 3 Opus (Bedrock)            | anthropic.claude-3-opus-20240229-v1:0
# Anthropic - Claude 3.5 Sonnet (Bedrock)        | anthropic.claude-3-5-sonnet-20240620-v1:0
# Anthropic - Claude 3.5 Sonnet v2 (Bedrock)     | anthropic.claude-3-5-sonnet-20241022-v2:0
# Anthropic - Claude 3.5 Haiku (Bedrock)         | anthropic.claude-3-5-haiku-20241022-v1:0
# Anthropic - Claude 3.7 Sonnet (Bedrock)        | anthropic.claude-3-7-sonnet-20250219-v1:0
# Anthropic - Claude 4 Opus (Bedrock)            | anthropic.claude-opus-4-20250514-v1:0
# Anthropic - Claude 4 Sonnet (Bedrock)          | anthropic.claude-sonnet-4-20250514-v1:0
...
# Meta - Llama 3.2 1B Instruct (Bedrock)         | meta.llama3-2-1b-instruct-v1:0
# Meta - Llama 3.2 3B Instruct (Bedrock)         | meta.llama3-2-3b-instruct-v1:0
# Meta - Llama 3.2 11B Instruct (Bedrock)        | meta.llama3-2-11b-instruct-v1:0
# Meta - Llama 3.2 90B Instruct (Bedrock)        | meta.llama3-2-90b-instruct-v1:0
# Mistral - 7B Instruct (Bedrock)                | mistral.mistral-7b-instruct-v0:2
...
We've also extended the out-of-the-box [agent metrics](/concepts/metrics/agentic/agentic-overview) available within Galileo with our four new agent-specific metrics that measure the dimensions that impact user experience in production - [Agent Flow](/concepts/metrics/agentic/agent-flow), [Agent Efficiency](concepts/metrics/agentic/agent-efficiency), [Conversation Quality](https://v2docs.galileo.ai/concepts/metrics/agentic/conversation-quality), and [User Intent Change](httpshttps://v2docs.galileo.ai/concepts/metrics/agentic/intent-change).
