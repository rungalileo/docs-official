...
<Update label="2025-10-07" description="Documentation on using experiments in unit tests, Google ADK support via OTel, UI and SDK improvements">
...
- Tags can be updated through the `update_span` and `update_trace` methods
