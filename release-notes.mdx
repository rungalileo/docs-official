...
Galileo's [custom model integrations](https://v2docs.galileo.ai/sdk-api/third-party-integrations/model-integrations/custom-model-integrations/custom-model-integrations) now support model properties for users who wish to further customize LLM integration parameters.

[Learn more](https://v2docs.galileo.ai/sdk-api/third-party-integrations/model-integrations/custom-model-integrations/custom-model-integrations#model-properties)
...
[Learn more](https://v2docs.galileo.ai/concepts/annotations/overview#annotation-queues-enterprise-beta)
...
To autotune a metric, hover over any LLM-as-a-judge metric and click **Add feedback**. [Learn more](https://v2docs.galileo.ai/concepts/metrics/autotune-llm-as-a-judge-metrics).
...
![Metric roll-up boolean](images/release-notes/2026-03-27/metric-rollup-boolean-metric.png)
