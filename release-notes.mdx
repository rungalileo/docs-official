...
Galileo's [integration with CrewAI](sdk-api/third-party-integrations/crewai/crewai.mdx) has been improved to provide better observability and debugging capabilities for multi-agent workflows. The enhanced integration now offers improved logging, metrics tracking, and session management for complex agent interactions.
