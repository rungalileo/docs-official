...
<Update label="2026-02-13" description="OpenAI Responses API support, new integrations, metric recomputation flow, and SQL metrics">
...
![Metric recomputation flow](images/release-notes/2026-02-13/recompute.gif)
...
[Learn more here](/concepts/metrics/text2sql/text2sql-overview)
