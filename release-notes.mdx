...
### Key New Features
More powerful agent observability with updates to three complementary views—Graph, Timeline, and Conversation—designed to help you debug faster, detect issues earlier, and understand agent performance from every angle.
...
- Reproduce and resolve edge cases faster
    ...
    ![Conversation View Updates](/images/release-notes/2025-06-16/2025-06-16-Conversation-View.gif)
...
With these improvements, one can get a more holistic view of agent behavior. 
