...
<Update label="2026-03-20" description="Autotune Queues, Metric roll-up features, Dataset and Experiments UI improvements">

## Key new features and improvements

### Autotune Queues

Galileo now supports Autotune Queues, a new way to improve LLM-based metric performance through expert feedback.

An enhancement to the Continuous Learning via Human Feedback (CLHF) feature, Autotune Queues let annotators and subject matter experts:

- correct metric outputs
- define expected values
- provide natural language explanations across selected logs

![Autotune Queues: Add Feedback](images/release-notes/2026-03-20/autotune-queues-add-feedback.png)

To provide autotune feedback, simplify hover over an LLM-based metric and click "Add feedback".
...
## This section is hidden. to unhide when this page is updated

 ![Learn more](https://v2docs.galileo.ai/getting-started/experiments)
