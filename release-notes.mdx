...
Keep close tabs on your AI apps and agents with the ability to create Slack or email alerts on your log streams. Get notified on the metrics that matter most to you and your team — whether its correctness, output PII, context relevant, or more. Leverage flexible thresholds and conditions to optimize for the right balance between signal and noise.
...
Protect has been added to the latest version of the Galileo Python SDK to intercept prompts and outputs to proactively safeguard your organization and your end-users from unwanted or even dangerous outputs. Power Protect’s safeguards through Galileo Metrics. Protect is specifically designed to defend your application against:
