...
- [Luna Studio Quickstart](https://docs.galileo.ai/luna-studio/quickstart)
...
<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.loom.com/embed/bcdd51decc874adfb5e69464d4df7473"
  title="Editable Trends View"
  frameBorder="0"
  allowFullScreen
></iframe>
