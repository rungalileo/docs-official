...
Keep close tabs on your AI apps and agents with the ability to create Slack or email alerts on your Log streams. Get notified on the metrics that matter most to you and your team — whether its [correctness](/concepts/metrics/rag/generation-quality/correctness), output [PII](/concepts/metrics/safety-and-compliance/pii), [context relevance](/concepts/metrics/rag/retrieval-quality/context-relevance), or more. Leverage flexible thresholds and conditions to optimize for the right balance between signal and noise.
