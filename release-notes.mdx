...
Distributed Tracing (Beta) is now available for testing and feedback.
![Distributed Tracing (Beta)](/images/release-notes/2025-12-12/distributed-tracing.png)

### LLMs added to Playground, Prompt Store, and Metrics Hub

These Large Language Models from Anthropic have been added to Playground, Prompt store, and Metrics hub:
...
### OpenTelemetry and OpenInference improvements

- We have made it easier to setup integrations to agent frameworks through OTEL.
