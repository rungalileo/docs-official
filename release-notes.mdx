...
<Update label="2026-07-21" description="AI-assisted custom code-based metrics, Billing Usage page, AI assistant enhancements, Trace Count system metric">
...
Track the usage of traces, spans, and Luna tokens for your projects on the [Billing Usage](https://app.galileo.ai/settings/billing-usage) page.
