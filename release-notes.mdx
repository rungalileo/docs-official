...
Announcing the beta launch of the Galileo AI Assistant to troubleshoot your agentic system. Ask the AI Assistant questions like "Why did the agent take this action?" or "What's driving this evaluation metric?" to get answers with links straight to the evidence and a concrete fix.

The AI Assistant pulls data from your traces, spans, sessions, and evaluation scores to provide helpful insights. Learn more

Reach out to <a href="mailto:support@galileo.ai">support@galileo.ai</a> to enable AI Assistant for your enterprise account.
