...
<Update label="2026-08-07" description="Galileo is now Splunk Agent Observability">

## Galileo is now Splunk Agent Observability

As of August 7, 2026, Galileo is now Splunk Agent Observability.

The documentation on this website applies to customers who onboarded prior to August 7, 2026. If you onboarded after this date, use the documentation on [agent-observability-docs.splunk.com](https://agent-observability-docs.splunk.com).

</Update>

<Update label="2026-08-04" description="Annotation Queues and dark mode now generally available, OpenAI model updates, AI Assistant (Beta) enhancement">

## Key new features and improvements

### Annotation Queues now generally available

Organize sessions, traces, and spans into queues for structured review by subject matter experts, making it easier to scale human feedback across your AI applications. [Learn more](/concepts/annotations/overview#annotation-queues)

![Annotation Queues page in the UI](/images/release-notes/2026-08-04/annotation-queues-dark-mode.png)

### AI Assistant (Beta) now available beyond Log Streams and Experiments

The AI Assistant (Beta) now works everywhere you debug within Galileo.

Troubleshoot your agentic system with the AI Assistant. Ask the AI Assistant questions like “Why did the agent take this action?” or “What's driving this evaluation metric?” and it answers with links straight to the evidence and a concrete fix, pulling from your traces, spans, sessions, and evaluation scores. [Learn more](/concepts/ai-assistant)

![AI Assistant panel inside a Log Stream](/concepts/ai-assistant/ai-assistant-open.png)

### OpenAI model updates

GPT 5.6 Sol, Terra, and Luna models are now available in Playground, Prompt store, Synthetic Data Generation, and Metrics Hub.

### Dark mode now generally available

For a more comfortable experience with the Galileo user interface, you can now switch between light, dark, and system mode. System mode automatically matches your browser and operating system settings.

To switch modes, select your user profile in the top-right corner and use the mode switcher in the user menu.

![Light, dark, and system mode selector](/images/release-notes/2026-08-04/dark-mode-selector.webp)

</Update>

<Update label="2026-07-21" description="AI-assisted custom code-based metrics, GA Model Pricing and Integration Costs pages, Billing Usage page, AI assistant enhancements, Trace Count system metric, multimodal out-of-the-box evaluation metrics">

## Key new features and improvements

### Generate custom code-based metrics with AI

Create custom code-based metrics in seconds with **Help me write**. Describe what you want to evaluate in plain English, and Galileo generates a runnable scorer function directly in the code editor. [Learn more](/concepts/metrics/custom-metrics/custom-metrics-ui-code#ai-assisted-code-generation)

![AI-assisted code generation](/images/g2/custom-metrics-ai-assisted-code.png)

### AI Assistant enhancements

[AI Assistant](/concepts/ai-assistant) now sorts signals by criticality, helping you prioritize the most important issues. Each signal shows its impact across spans and sessions along with when it was last updated.

Tool calls now automatically collapse after you submit a query, making responses easier to scan and navigate.

### Model Pricing and Integration Costs pages generally available

The [Model Pricing](/concepts/costs/model-pricing-settings) and [Integration Costs](/concepts/costs/integration-costs) pages are now viewable by all organization users. Use these pages to understand how your organization's AI agents are impacting budgets.

### View billing usage for your organization

Track the usage of traces, spans, and Luna tokens for your projects on the new [Billing Usage](https://app.galileo.ai/settings/billing-usage) page.

![Billing Usage page](/images/release-notes/2026-07-21/billing-usage-page.png)

### Log stream alerts on trace count

You can now [create Log stream alerts](/how-to-guides/basics/set-up-alerts-on-logs) using the **Trace Count** system metric. For any Log stream, get notified when traces are ingested at a higher or lower rate than expected within a specified time period.

### Multimodal out-of-the-box evaluation metrics

Out-of-the-box evaluation metrics now support image/PDF and audio, in addition to text. The following metrics are available in all three variants:
...
<Update label="2026-07-07" description="AI Assistant, global dashboards, webhook support for alerts, experiment groups, scaling improvements">

## Key new features and improvements

### AI Assistant (beta)

Announcing the launch of AI Assistant to troubleshoot your agentic system. Ask the AI Assistant questions like "Why did the agent take this action?" or "What's driving this evaluation metric?" and it answers with links straight to the evidence and a concrete fix, pulling from your traces, spans, sessions, and eval scores. [Learn more](/concepts/ai-assistant)

![AI Assistant](/images/release-notes/2026-07-07/ai-assistant.png)

Reach out to <a href="mailto:support@galileo.ai?subject=Interest%20in%20AI%20Assistant%20(Beta)">support@galileo.ai</a> to enable AI Assistant for your enterprise account.

### Chart across projects with global dashboards

Global dashboards bring every metric across your projects and Log streams into a single, customizable view. Chart across projects to build dashboards for safety, evaluations, usage, and more to get a high-level picture of how your AI agents are performing over time across your organization.

![Global dashboards](/images/release-notes/2026-07-07/global-dashboards.png)

### Webhook support for alerts

Get notified about unexpected issues by configuring a webhook to send Galileo alert events to any HTTP endpoint, such as a custom alerting system, an incident management platform, or an internal automation pipeline. [Learn more](/how-to-guides/basics/set-up-alerts-on-logs#generic-webhook-notifications)
...
Organize, compare, and rank experiments by creating experiment groups in the Galileo console or SDK. By default, experiments are now grouped by dataset. [Learn more](/sdk-api/experiments/experiment-groups)

![Experiment groups](/images/console-ui/experiment-groups-list.png)

### Scaling improvements in Playground and experiments

Galileo's Playground and experiments can now process much larger datasets. New batched processing supports metrics computation on datasets with thousands of rows at a time.

</Update>

<Update label="2026-06-23" description="Multi-turn conversations in experiments, test metrics using datasets, Inline alerts in Trends View">

## Key new features and improvements

### Evaluate multi-turn conversations in experiments

The Galileo [Python SDK](/sdk-api/python/sdk-reference) now supports evaluating multi-turn conversations in [experiments](/sdk-api/experiments/experiments). With this feature, you can use Galileo session metrics to test how multi-turn datasets perform on your agents before deploying changes to production.

![Multi-turn conversations in experiments screenshot](/images/release-notes/2026-06-23/multi-turn-conversations-experiments.png)
...
3. View the sessions and metrics in the **Experiments** UI in a new **Sessions** tab.

[Learn more](https://github.com/rungalileo/sdk-examples/tree/main/python/experiments/multi-turn)

### Test metrics using datasets

Validate a custom metric against a labeled dataset and get a macro F1 score or RMSE for how well it matches metric ground truth. Trust metrics before deploying, catch drift, and confirm Autotune improvements. [Learn more](/concepts/metrics/custom-metrics/test-metrics)

![Test metrics using datasets screenshot](/images/release-notes/2026-06-23/test-metrics-with-datasets.png)

### Inline alerts in Trends View

Set alerts directly from the **Trends View** without leaving your evaluation workflow.

![Inline alerts in Trends View](/images/release-notes/2026-06-23/set-alerts-from-trends-view.png)

</Update>

<Update label="2026-06-05" description="Agent Control">

## Key new features and improvements

### Agent Control for enterprise customers

Agent Control helps safeguard agentic AI applications. It allows enterprises to define guardrails and manage agent governance from one central place.

![Agent control screenshot](images/release-notes/2026-06-05/agent-control-screenshot.png)

Use Agent Control to block harmful content, prompt injection, PII leakage, and other risks without requiring changes to agent code.

[Learn more](/concepts/agent-control/overview)

</Update>

<Update label="2026-05-22" description="Luna Studio, Integration cost charts">

## Key new features and improvements

### Luna Studio for enterprise customers

Announcing Luna Studio, a new fine-tuning suite that enables enterprises to train low-latency, cost-effective Small Language Model (SLM) metrics.

Use Luna Studio to help evaluate AI agents at scale and with lower total cost of ownership.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/LQC95Wugono"
  title="Luna Studio"
  frameBorder="0"
...
- [Luna Studio Quickstart](https://docs.galileo.ai/luna-studio/ui/quickstart)
- [Luna-2: Scalable Single-Token Evaluation with Small Language Models (Research paper)](https://arxiv.org/abs/2602.18583)
- [Luna eval cost at scale (Calculator)](https://galileo.ai/luna-savings-calculator)

### Integration cost charts

A new "Integration Costs" settings page (now in Beta preview) allows admins to track projects costs for [LLM-as-a-judge metrics](https://docs.galileo.ai/concepts/metrics/how-llm-as-judge-metrics-are-calculated).

![Model prices](images/release-notes/2026-05-22/integration-costs-beta.png)

Use this feature to have a more accurate view of how your organization's AI evaluators are impacting budgets.

[Learn more](/concepts/costs/integration-costs)
...
![Trends view](images/release-notes/2026-05-08/trends-view.png)
...
![Test metrics with datasets](images/release-notes/2026-05-08/dataset-testing.png)
...
![Model prices](images/release-notes/2026-05-08/model-pricing-prices-table-short.png)
...
![Annotation Queue charts](images/release-notes/2026-05-08/annotation-queue-overview-charts.png)
...
<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/lp0sjaV73fk"
...
![Improved error message](images/release-notes/2026-04-24/improved-error-message.png)
...
![Playground variables](images/release-notes/2026-04-10/playground-variables.png)

### Logs filter update

Galileo's Logs can now automatically display available columns to filter.

![Filter by column name](images/release-notes/2026-04-10/filter-by-column-name.png)
...
![Annotation Queues: Auto advance and keyboard shortcuts](images/release-notes/2026-04-10/annotation-queues-auto-advance.png)
...
<iframe className="w-full aspect-video rounded-xl" src="https://www.loom.com/embed/bcdd51decc874adfb5e69464d4df7473" title="Editable Trends View" frameBorder="0" allowFullScreen></iframe>
...
![Metric roll-up logic modal (a new metric)](images/release-notes/2026-03-27/metric-rollup-new-metric.png)
...
![Metric roll-up logic menu item (existing metric)](images/release-notes/2026-03-27/metric-rollup-existing-metric.png)

### Datasets UI improvements

![Dataset 4 columns example](images/release-notes/2026-03-27/dataset-fields-example.avif)
...
![Create Experiment button](images/release-notes/2026-03-27/create-experiment-button.png)

New "Create Experiment" buttons allow you to easily create experiments through the Galileo Console UI.

![Create Experiment modal](images/release-notes/2026-03-27/create-experiment-from-dataset-modal.png)
...
![Create Experiment menu in Datasets](images/release-notes/2026-03-27/create-experiment-from-dataset-menu.png)
