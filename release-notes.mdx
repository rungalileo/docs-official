...
<Update label="2026-05-08" description="Multi-agent observability with A2A, Expanded OpenTelemetry support, Model pricing settings, Annotation Queue overview charts">
...
Queue admins are now able to view assorted charts on Annotation Queue ratings and progress.
