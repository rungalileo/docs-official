...
<Update label="2026-04-24" description="Multimodal observability, Signals enterprise support, A2A support, Strands update, Error catalog">
...
Galileo now supports end-to-end distributed tracing to multi-agent systems using the Google A2A (Agent-to-Agent) protocol.

[Learn more](/sdk-api/third-party-integrations/a2a)

### Strands Agents SDK integration update

Galileo's [Strands Agents SDK](https://strandsagents.com/) integration using OpenTelemetry (OTel) now supports a new experimental mode available in `strands-agents` v1.34.0 and up.
