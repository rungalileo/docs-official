...
Apply these metrics at [span](/concepts/logging/spans#spans), [trace](/sdk-api/logging/galileo-logger#start-a-trace#traces), or [session levels](/concepts/logging/sessions/sessions-overview), or create agentic metrics to evaluate complete workflows.
