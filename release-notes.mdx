...
<Update label="2025-06-18" description="Luna 2 Available in Enterprise">

### Key New Features
[Luna 2](https://v2docs.galileo.ai/concepts/luna/luna#luna-2-overview) is now available for Enterprise Customers. Luna 2 is a major upgrade that brings purpose-built intelligence to every evaluation and guardrail use case. With a redesigned architecture and rigorous RLAIF training pipelines, Luna 2 delivers:
