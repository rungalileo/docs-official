...
<Update label="2026-03-20" description="Autotune, Metric roll-up features, Dataset and Experiments UI improvements">

## Key new features and improvements

### Autotune

Galileo now supports Autotune, a new way to improve LLM-based metric performance through expert feedback.
...
An enhancement to the Continuous Learning via Human Feedback (CLHF) feature, Autotune let annotators and subject matter experts:

- correct metric outputs
- define expected values
- provide natural language explanations across selected logs

To autotune a metric, hover over any LLM-based metric and click "Add feedback"
