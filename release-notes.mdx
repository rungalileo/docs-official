...
![Multi-turn conversations in experiments screenshot](/images/release-notes/2026-06-23/multi-turn-conversations-in-experiments.png)
...
Validate a custom metric against a labeled dataset and get a macro F1 score or RMSE for how well it matches metric ground truth. Trust metrics before deploying, catch drift, and confirm Autotune improvements. Learn more

![Test metrics using datasets screenshot](/images/release-notes/2026-06-23/test-metrics-using-datasets.png)
