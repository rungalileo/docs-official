...
<Update label="2026-07-21" description="AI-assisted custom code-based metrics, GA Model Pricing and Integration Costs, Billing Usage page, AI assistant enhancements, Trace Count system metric">
...
[Model Pricing](/concepts/costs/model-pricing-settings) and [Integration Costs](/concepts/costs/integration-costs) pages are now viewable by all organization users. These features help teams to have more accurate views of how their organization's AI agents are impacting budgets.
