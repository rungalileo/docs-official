...
[Distributed Tracing (Beta)](/sdk-api/logging/distributed-tracing) is now available for testing and feedback. You can find an example if this in our [SDK examples repo](https://github.com/rungalileo/sdk-examples/tree/main/python/logging-samples/distributed-tracing).
