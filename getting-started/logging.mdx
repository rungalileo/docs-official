...
A [span](/concepts/logging/spans) is the atomic unit of logging in Galileo. Each represents a discrete operation or step within your AI application.
...
A [trace](/concepts/logging/traces) is a collection of related spans that, together, represent a single logical response.
...
A [session](/concepts/logging/sessions/sessions-overview) is a collection of `Traces` and `Spans` emitted by your application. 
...
[Log streams](/concepts/logging/logstreams) ​are organizational units that group related sessions and traces together based on logical deployments, applications, or environments.
...
You can access the Galileo Logger directly using the [Python SDK](/sdk-api/python/sdk-reference) or [TypeScript SDK](/sdk-api/typescript/sdk-reference).


### Next steps 

<Card title="Understanding the logger arguments" icon="book" href="/getting-started/logger-arguments-best-practices">
  Learn how to effectively use logger arguments for maximum observability and debugging capabilities.

</Card>

<Card title="Learn about logging in Python" icon="python" href="/sdk-api/python/sdk-reference">
  Learn how to use the Galileo SDK to log data from your application.

</Card>

<Card title="Learn about logging in TypeScript" icon="js" href="/sdk-api/typescript/sdk-reference">
  Learn how to use the Galileo SDK to log data from your application.

</Card>

<Card title="Learn about different logging methods" icon="code" href="/sdk-api/logging/logging-basics">
  Understand the different approaches to logging with the Galileo SDK
