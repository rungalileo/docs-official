...
<Steps>
  ...
  <Step title="Apply it to your own Log Stream">
...
<CardGroup cols={2}>
<Card title="Response Quality metrics" icon="message" horizontal href="/concepts/metrics/response-quality/response-quality-overview">
