...
![The default Log stream in the project dashboard](/getting-started/sample-projects/multi-agent-view-all-logs-button.webp)
...
![The Log Stream Insights button](/getting-started/sample-projects/multi-agent-insights-button.webp)
