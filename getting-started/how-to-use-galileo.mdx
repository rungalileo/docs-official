...
<Card title="Learn more about Logging" icon="terminal" href="/sdk-api/logging/logging-basics" horizontal>
  Learn how to use the Galileo SDK to log data from your application.

</Card>

<Card title="Learn about Experiments" icon="flask" href="/getting-started/experiments" horizontal>
