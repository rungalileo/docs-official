---
title: Hello Galileo!
description: Already signed up for Galileo? Here's the code to log your first trace
---
...
Create a `.env` file with the following settings in your application folder. Set your Galileo API key, project name, Log stream name, and your OpenAI API key.
<br/><br/>
...
- **I don't have an OpenAI key**: Galileo supports any LLM, with the OpenAI SDK the easiest to get started with. You can spin up an [Ollama](https://ollama.com) instance and use the code above with it, or manually log using any LLM. We have examples with more LLMs in the [log and evaluate your first trace guide](/getting-started/log-and-evaluate-first-trace). Check out the [logger documentation](/sdk-api/logging/logging-basics) for more details.
- **I don't see any metrics**: For Galileo to calculate metrics, you need to add an [LLM integration](/concepts/metrics/overview#configure-galileo-for-out-of-the-box-and-llm-as-a-judge-metrics), and [turn on metrics for the Log stream](/getting-started/log-and-evaluate-first-trace#configure-metrics-for-your-log-stream). Once done, re-run your app and you will see metrics being calculated.
