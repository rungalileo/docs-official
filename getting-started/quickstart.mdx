...
<Note>
Set the project and log stream names as environment variables.
```
...
4. [Generate a Galileo API key](https://app.galileo.ai/settings/api-keys) and set it as an environment variable:
