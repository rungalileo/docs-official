...
<Screenshot
  alt="Select metric"
  placeholder="Add screenshot of Select metric"
  caption="Select metric"
  imageUrl="/screenshots/metrics-configuration.png"
/>
...
<CodeGroup>
```bash Python
pip install "galileo[all]" python-dotenv
```

```bash TypeScript
npm install galileo-experimental
```
</CodeGroup>
</Step>
...
<Screenshot
  alt="Run Trace"
  placeholder="Add screenshot of run trace"
  caption="Run Trace"
  imageUrl="/screenshots/chatbot-trace.png"
/>
...
<Screenshot
  ...
  placeholder="Add screenshot of metric explanation"
  caption="Metric Explanation"
  imageUrl="/screenshots/chatbot-low-instruction-adherence-metric-explanation.png"
/>
...
<Screenshot
  alt="Trace improvement"
  placeholder="Add screenshot of Trace improvement"
  caption="Trace improvement"
  imageUrl="/screenshots/chatbot-trace-improvement.png"
/>
