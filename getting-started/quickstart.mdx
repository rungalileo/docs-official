...
Create a project in the [Galileo Console](https://app.galileo.ai).
...
Create a log stream in the [Galileo Console](https://app.galileo.ai).
...
Set up metrics in the [Galileo Console](https://app.galileo.ai).
...
<Step title="Log in to Galileo Console">

In your browser, open the [Galileo Console](https://app.galileo.ai) and log in or create an account.
...
In the [Galileo Console](https://app.galileo.ai), use the drop down in the top-left to select your default project, "My first project".

![Select Project](/images/console-ui/project-select.png)
</Step>
...
[Metrics](/concepts/metrics) are used to evluate and track the performance of AI models in your experiments.
...
In this tutorial, we want to measure the model's **Instruction Adherence**. Click the toggle next to "Instruction Adherence" to add the Metric.
...
![Add Instruciton Adherence](/images/console-ui/instruction-adherence-metric.png)
</Step>
...
With your Metrics configured, you are now ready to build the project **application** on your local machine.
...
Check your terminal for the output and the [Galileo Console](https://app.galileo.ai) to review the run Trace and Metrics.

![Run Trace](/images/g2/chatbot-trace.png)
...
![Metric Explanation](/images/g2/chatbot-low-instruction-adherence-metric-explanation.png)
