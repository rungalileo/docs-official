...
import PythonOpenAI from "/snippets/content/get-started/quickstart/python-openai.mdx"
import PythonAzureOpenAI from "/snippets/content/get-started/quickstart/python-azure.mdx"
import PythonAnthropic from "/snippets/content/get-started/quickstart/python-anthropic.mdx"

import TypeScriptOpenAI from "/snippets/content/get-started/quickstart/typescript-openai.mdx"
import TypeScriptAzureOpenAI from "/snippets/content/get-started/quickstart/typescript-azure.mdx"
import TypeScriptAnthropic from "/snippets/content/get-started/quickstart/typescript-anthropic.mdx"
...
🎉 **Congratulations**, you have logged your first trace! Your [next step is to evaluate this trace using Galileo metrics](/getting-started/evaluate-and-improve), and use this evaluation to improve the LLM prompts to get a better response.
...
<CardGroup cols={2}>
<Card title="Evaluate your first trace" icon="code" horizontal href="/getting-started/evaluate-and-improve">
