---
title: Build an app with Galileo
---
...
- A Galileo account. If you don't already have one, sign up for a free account at [app.galileo.ai](https://app.galileo.ai)
...
- `GALILEO_LOG_STREAM` : The name of your Galileo Log stream. If this doesn't exist, it will be created.
...
- **Application Guides**: Optimize [Conversational AI](/how-to-guides/conversational-ai/instruction-adherence), [RAG Systems](/how-to-guides/rag/preventing-out-of-context-information), or [AI Agents](/how-to-guides/agentic-ai/basic-example)
- **Advanced Features**: Run [Experiments](/concepts/experiments/running-experiments-in-console), create [Custom Metrics](/concepts/metrics/custom-metrics/custom-metrics-ui-llm), and detect [Failure Modes](/concepts/logging/traces#identifying-failure-modes)
