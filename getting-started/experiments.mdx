...
<Card title="Run an Experiment in the Playground UI" icon="hand-pointer" href="/concepts/experiments/running-experiments-in-console" horizontal>
  Learn how to run experiments in the Galileo playground UI.

</Card>

<Card title="Run an Experiment with Code" icon="code" href="/concepts/experiments/running-experiments" horizontal>
  Learn how to run experiments in Galileo through code.
