...
<Note>
This code defaults to using GPT-4o. If you want to use a different model, update the `model_alias` in the call to run experiment.
</Note>
...
Experiment My Experiment has started and is currently processing. Results will be available at https://app.galileo.ai/project/.../experiments/...
