...
In the Galileo console UI, "Create Experiment" buttons allow you to easily add experiments.
...
If you don't already have an integration (e.g. with OpenAI), a "Configure integration" link will appear for you to add a valid integration for a prompt.
