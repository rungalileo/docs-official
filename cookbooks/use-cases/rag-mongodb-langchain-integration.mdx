...
Find the full notebook [here](https://github.com/rungalileo/examples/blob/2d39d2d9dafdcf6b6dcb0b7ecb3e51a7546ce9ce/examples/RAG/logstreams/Galileo_LangGraph_Agent_with_MongoDB_Atlas_Vector_Search_for_RAG.ipynb)