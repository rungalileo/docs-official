...
# custom deployment, and not using the free tier at app.galileo.ai.
...
- [Example Chat App with streaming](https://github.com/rungalileo/elasticsearch-labs/tree/main/python/rag/elastic-chatbot-rag-app)