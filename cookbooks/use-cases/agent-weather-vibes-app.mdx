...
### Sample Application
To see a completed version of this application and other examples using the Galileo SDK, check out our [SDK Examples Repository](https://github.com/rungalileo/sdk-examples)

# 🌦️ Weather Vibes Agent Cookbook

A comprehensive tutorial for building a weather-based recommendation agent with Galileo Agentic Evaluations.
## Overview
