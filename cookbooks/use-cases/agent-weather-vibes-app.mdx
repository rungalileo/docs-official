...
Your project name will become the GALILEO_PROJECT_KEY, while your log stream will become the GALILEO_LOG_STREAM.  If you left it as default, the log stream key will be "
...
- Star the [Galileo SDK-examples repo]()to bookmark more ways to get started with the Galileo SDK.
- Follow [Galileo on LinkedIn]() to stay in touch with the latest news and reosurces. 
