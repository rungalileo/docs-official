...
| [Chunk Attribution](/concepts/metrics/response-quality/chunk-attribution)                     | `GalileoScorers.chunk_attribution_utilization`                    |
| [Chunk Utilization](/concepts/metrics/response-quality/chunk-utilization)                     | `GalileoScorers.chunk_attribution_utilization`                    |
...
| [BLEU](/concepts/metrics/expression-and-readability/bleu-and-rouge#understanding-bleu-score)  | `GalileoScorers.Bleu` |
| [Chunk Attribution](/concepts/metrics/response-quality/chunk-attribution)                     | `GalileoScorers.ChunkAttributionUtilization` |
| [Chunk Utilization](/concepts/metrics/response-quality/chunk-utilization)                     | `GalileoScorers.ChunkAttributionUtilization` |
| [Completeness](/concepts/metrics/response-quality/completeness)                               | `GalileoScorers.Completeness` |
| [Context Adherence](/concepts/metrics/response-quality/context-adherence)                     | `GalileoScorers.ContextAdherence` |
| Context Relevance (Query Adherence)                                                           | `GalileoScorers.ContextRelevance` |
| [Correctness (factuality)](/concepts/metrics/response-quality/correctness)                    | `GalileoScorers.Correctness` |
...
| [Chunk Attribution](/concepts/metrics/response-quality/chunk-attribution)                     | `GalileoScorers.chunk_attribution_utilization_luna`                         |
| [Chunk Utilization](/concepts/metrics/response-quality/chunk-utilization)                     | `GalileoScorers.chunk_attribution_utilization_luna`                         |
...
| [Chunk Attribution](/concepts/metrics/response-quality/chunk-attribution)                     | `GalileoScorers.ChunkAttributionUtilizationLuna` |
| [Chunk Utilization](/concepts/metrics/response-quality/chunk-utilization)                     | `GalileoScorers.ChunkAttributionUtilizationLuna` |
