...
import SnippetGettingStartedOpenAIPythonFuture from "/snippets/code/python-future/getting-started/getting-started-openai.mdx";
...
<CodeGroup>
  ...
  <SnippetGettingStartedOpenAIPythonFuture />
