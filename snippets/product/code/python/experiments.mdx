...
os.environ["GALILEO_API_KEY"] = "<YOUR_API_KEY>"  # find at https://app.galileo.ai/galileo-v2/settings/api-keys
...
prompt = create_prompt(
    ...
    template=[
        Message(
            ...
            content="Galileo brings automation and insight to AI evaluations so you can ship with confidence.",
        ),
