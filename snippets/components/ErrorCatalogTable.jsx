  ...
  const errors =[
    {
      ...
      "error_group": "shared",
      "severity": "high",
      "default_message": "An unexpected error occurred. The error has been logged.",
    ...
    },
    {
      ...
      "user_action": "Check the metric configuration or LLM integration settings and retry.",
      "retriable": false
    },
    {
      "error_code": 1027,
    ...
    },
    {
      ...
      "user_action": "The scoring budget for this record was exhausted before it completed. Please retry; if it persists, contact support.",
      "retriable": true
    },
    {
      "error_code": 2021,
    ...
    },
    {
      ...
      "error_group": "metrics",
      "severity": "medium",
      "default_message": "The scoring service is temporarily busy.",
    ...
    },
    {
      ...
      "error_group": "integrations",
      "severity": "medium",
      "default_message": "No testable generic webhook destination is configured.",
      "user_action": "Add a generic webhook destination before running a test, or retest a destination that is in untested state.",
      "retriable": false,
      "http_status_code": 422
    },
    {
    ...
    },
    {
      ...
      "severity": "high",
      "default_message": "ClickHouse request failed.",
      "user_action": "Retry after a few minutes or contact support if it persists.",
      "retriable": true,
      "http_status_code": 503
    },
    {
      ...
      "error_group": "clickhouse",
      "severity": "high",
      "default_message": "Timed out waiting on ClickHouse.",
      "user_action": "The query is too slow to complete; narrow its scope or contact support if it persists.",
      "retriable": false,
      "http_status_code": 504
    },
    {
      ...
      "error_group": "clickhouse",
      "severity": "medium",
      "default_message": "Failed to load available columns. Please try again or narrow the time range.",
    ...
    },
    {
      ...
      "severity": "medium",
      "default_message": "This metric took too long to calculate for the selected time range.",
      "user_action": "Narrow the time range or select fewer projects, then retry.",
      "retriable": true,
      "http_status_code": 504
    },
    {
      ...
      "error_group": "agent_observability",
      "severity": "medium",
      "default_message": "This metric needed more memory than is available for the selected time range.",
      "user_action": "Narrow the time range or select fewer projects, then retry.",
      "retriable": true,
    ...
    },
    {
      ...
      "error_group": "agent_observability",
      "severity": "medium",
      "default_message": "This metric could not be calculated.",
      "user_action": "Retry. If this persists, contact support.",
      "retriable": true,
      "http_status_code": 500
    },
    {
      ...
      "error_group": "agent_observability",
      "severity": "low",
      "default_message": "The selected time range is too long for this interval.",
      "user_action": "Choose a coarser interval or a shorter time range.",
      "http_status_code": 422,
      "retriable": false
    },
    {
      ...
      "error_group": "agent_observability",
      "severity": "low",
      "default_message": "The requested dashboard scope was not found.",
      "user_action": "Check the selected projects or log streams and try again.",
      "retriable": false,
      "http_status_code": 404
    }
  ];
                        ...
                        <table style={tableStyle}>
                            <thead>
                                <tr style={{ borderBottom: `2px solid ${colors.border}` }}>
                                    <th style={{ ...errorCodeHeaderCellStyle, textAlign: 'left', minWidth: '7rem' }} onClick={() => handleSort('error_code')}>
                                    ...
                                    <th style={{ ...baseHeaderCellStyle, textAlign: 'left', minWidth: '6rem' }} onClick={() => handleSort('severity')}>
                            ...
                            <tbody>
                                {groupedErrors[group].map((error, idx) => (
                                    ...
                                    >
                                        <td style={{ ...errorCodeDataCellStyle, fontWeight: 500, minWidth: '7rem' }}>
                                        ...
                                        <td style={{ ...baseCellStyle, minWidth: '6rem' }}>
                                            <span style={{ 
