  ...
  input: [
    {
      role: "user",
      content: `
      Based on these documents, what were the major causes
      of World War I? Documents: [...]
      `,
    },
  ],
  output: {
    role: "assistant",
    content: `
    The major causes of World War I included the assassination of
    Archduke Franz Ferdinand, militarism, alliances, imperialism,
    and nationalism...
    `,
  },
  model: "gpt-4o",
