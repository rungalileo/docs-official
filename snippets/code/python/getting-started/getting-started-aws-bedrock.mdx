...
galileo_context.init(project="MyFirstEvaluation7",
                     log_stream="MyFirstLogStream7")
...
logged_messages = [{"role": "system", "content": system_prompt}, {"role": "user", "content": user_prompt}]
