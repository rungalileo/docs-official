...
<Note>Visit the [Galileo PyPI package page](https://pypi.org/project/galileo/) for more installation options and version information.</Note>
...
- [Prompts](/sdk-api/prompts) - Creating and using prompt templates
