...
See the [`GalileoLogger` Python SDK docs](/sdk-api/python/reference/logger) for more details.
...
See the [`start_trace` Python SDK docs](/sdk-api/python/reference/logger#start-trace) for more details.
...
See the [`add_agent_span` Python SDK docs](/sdk-api/python/reference/logger#add-agent-span) for more details.
...
See the [`add_llm_span` Python SDK docs](/sdk-api/python/reference/logger#add-llm-span) for more details.
...
See the [`add_retriever_span` Python SDK docs](/sdk-api/python/reference/logger#add-retriever-span) for more details.
...
See the [`add_tool_span` Python SDK docs](/sdk-api/python/reference/logger#add-tool-span) for more details.
...
See the [`add_workflow_span` Python SDK docs](/sdk-api/python/reference/logger#add-workflow-span) for more details.
...
See the [`conclude`](/sdk-api/python/reference/logger#conclude) and [`flush`](/sdk-api/python/reference/logger#flush) Python SDK docs for more details.
...
See the [`add_single_llm_span_trace` Python SDK docs](/sdk-api/python/reference/logger#add-single-llm-span-trace) for more details.
