...
description: Instrumentation connects your application to Galileo so you can capture sessions, traces, spans, and other runtime data for observability and evaluation.
---
