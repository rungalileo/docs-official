...
The integration is based on the `CrewAIEventListener` class, which implements CrewAI's event listener. To use it, create an instance of the callback. When this is created, it automatically registers event handlers to capture the relevant events.
