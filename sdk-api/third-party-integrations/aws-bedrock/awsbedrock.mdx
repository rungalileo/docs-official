...
Galileo supports AWS Bedrock inference profiles,
allowing you to evaluate and monitor LLMs that run entirely
in your own AWS account while using Galileo’s evaluation,
...
- You register that role and your inference profile ARNs with Galileo.
