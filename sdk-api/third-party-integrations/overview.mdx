...
| :------------------ | :------ |
| A2A Protocol        | [`galileo-a2a`](/sdk-api/third-party-integrations/a2a/a2a) |
...
<CardGroup cols={2}>
<Card title="A2A Protocol" icon="python" horizontal href="/sdk-api/third-party-integrations/a2a/a2a">
