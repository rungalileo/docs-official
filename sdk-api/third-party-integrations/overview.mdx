...
<CardGroup cols={2}>
<Card title="Gemini Enterprise credentials" icon="google" horizontal href="/sdk-api/third-party-integrations/model-integrations/gemini-enterprise/gemini-enterprise-credentials">
    Create a Google Cloud service account JSON key and connect Gemini Enterprise to Galileo.
</Card>
<Card title="AWS Bedrock Inference Profiles" icon="aws" horizontal href="/sdk-api/third-party-integrations/model-integrations/aws-bedrock/awsbedrock">
