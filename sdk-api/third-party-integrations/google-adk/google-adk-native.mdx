...
This enables RAG-specific metrics like chunk relevance and context relevance to be calculated for your retrieval operations.
...
<Card title="RAG metrics" icon="chart-line" horizontal href="/concepts/metrics/rag/rag-overview">
