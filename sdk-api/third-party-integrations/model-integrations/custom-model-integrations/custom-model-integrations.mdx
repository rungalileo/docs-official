...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/qeqIw0KWGns?si=OV8g6v61cg_0FXh5"
...
List of built-in model aliases that can be used with `based_on`. For Gemini Enterprise
(formerly Vertex AI), see [how to set up credentials](/sdk-api/third-party-integrations/model-integrations/gemini-enterprise/gemini-enterprise-credentials).
...
<Accordion title="Click to expand">
  <AccordionGroup>
    ...
    <Accordion title="Gemini Enterprise">
      <AliasesVertexAi />
    </Accordion>
