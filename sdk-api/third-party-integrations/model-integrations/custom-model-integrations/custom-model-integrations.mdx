...
<Accordion title="Click to expand">
  <AccordionGroup>
    ...
    <Accordion title="Gemini Enterprise">
      Galileo model aliases for [Gemini Enterprise](/sdk-api/third-party-integrations/model-integrations/gemini-enterprise/gemini-enterprise-credentials) (previously Vertex AI):
