...
<Steps>
  ...
  <Step title="Configure Integration">
    ...
    This JSON example uses API key authentication. [See more examples](#json-examples).
...
For providers that use API key authentication (for example, [Together AI](https://www.together.ai/) or [Portkey](https://portkey.ai/)):
