...
<Card title="Invoke protection" horizontal icon="code" href="/sdk-api/protect/invoke-protection">
...
<Card title="Invoke runtime protection" icon="code" horizontal href="/sdk-api/protect/invoke-protection">
    Learn how to invoke runtime protection in code using the Galileo SDK.
</Card>
</CardGroup>
