...
<Note>Visit the [Galileo NPM package page](https://www.npmjs.com/package/galileo) for more installation options and version information.</Note>
...
- [**Datasets**](/sdk-api/datasets): Create and manage datasets for testing and evaluation
- [**Prompts**](/sdk-api/prompts): Create, version, and test prompt templates
