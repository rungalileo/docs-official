...
import SnippetCreatePrompt from "/snippets/code/typescript/sdk/prompts/create.mdx";
import SnippetGetPrompt from "/snippets/code/typescript/sdk/prompts/get.mdx";
import SnippetExperiment from "/snippets/code/typescript/sdk/datasets/experiments.mdx";
...
The simplest way to get started is to use our OpenAI client wrapper. This example will automatically produce a single-span trace in the Log stream UI:
