...
For [BLUE, ROUGE](/concepts/metrics/expression-and-readability/bleu-and-rouge), and [Ground Truth Adherence](/concepts/metrics/rag/generation-quality/ground-truth-adherence), you also need to set the ground truth in your dataset. This is set in the `output` column.
