...
If you are using the `log` wrapper or a third-party integration, this is handled for you. If you are logging manually, see [Custom function logging principles](#custom-function-logging-principles) below.
