...
import SnippetPythonRunExperimentBeta from "/snippets/code/python-beta/sdk/experiments/unit-tests/run-experiment.mdx"
import SnippetPythonGetExperimentBeta from "/snippets/code/python-beta/sdk/experiments/unit-tests/get-experiment.mdx"
import SnippetPythonPollExperimentBeta from "/snippets/code/python-beta/sdk/experiments/unit-tests/poll-experiment.mdx"
import SnippetPythonAssertExperimentBeta from "/snippets/code/python-beta/sdk/experiments/unit-tests/assert-experiment.mdx"
...
Optionally pass a **group name** with **`experiment_group`** so runs from your tests (for example CI jobs) land in the same [experiment group](/sdk-api/experiments/experiment-groups).
...
<SnippetPythonRunExperimentBeta />
</CodeGroup>
...
<SnippetPythonPollExperimentBeta />
</CodeGroup>
...
<SnippetPythonAssertExperimentBeta />
</CodeGroup>
...
<Card title="Experiment groups" icon="layer-group" horizontal href="/sdk-api/experiments/experiment-groups">
    Use group names in tests and browse groups in the console.
</Card>
