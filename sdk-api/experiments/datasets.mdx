...
When you create a dataset, it is uploaded to Galileo and available to future experiments. Datasets need to have unique names.
...
See the [`add_rows` Python SDK docs](/sdk-api/python/reference/datasets#add-rows) for more details.
