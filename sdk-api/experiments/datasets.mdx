...
See the [`add_rows` Python SDK docs](/sdk-api/python/reference/datasets#add-rows) or [`getDataset` TypeScript SDK docs](/sdk-api/typescript/reference/README/functions/getDataset) for more details.
...
See the [`list_datasets` Python SDK docs](/sdk-api/python/reference/datasets#list-datasets) or [`addRowsToDataset` TypeScript SDK docs](/sdk-api/typescript/reference/README/functions/addRowsToDataset) for more details.
