...
1. **`output`** - Reference outputs to evaluate your application. These can be the ground truth for [BLEU, ROUGE](/concepts/metrics/expression-and-readability/bleu-and-rouge), and [Ground Truth Adherence](/concepts/metrics/rag/generation-quality/ground-truth-adherence) metrics, or reference outputs for manual reference.
