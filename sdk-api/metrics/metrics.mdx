...
import SnippetCustomMetricsPython from "/snippets/code/python/concepts/metrics/custom-metrics.mdx";

import SnippetPresetMetricsTypeScript from "/snippets/code/typescript/concepts/metrics/preset-metrics.mdx";
import SnippetCustomMetricsTypeScript from "/snippets/code/typescript/concepts/metrics/custom-metrics.mdx";
...
<CodeGroup>
  <SnippetCustomMetricsPython/>
  <SnippetCustomMetricsTypeScript/>
</CodeGroup>
