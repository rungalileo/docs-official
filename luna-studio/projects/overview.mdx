...
description: "Top-level containers for related training runs."
---

A **project** is the top-level container in Luna Studio. It groups training runs that share a goal — typically tuning a single metric for a single application or domain.
...
<Frame caption="Projects page listing every project in your organization">
  ![Projects page](/images/luna-studio/projects/projects-home.png)
</Frame>
...
| Metrics      | Outline-style chips listing the metrics fine-tuned in this project's runs. |
...
<Warning>
  Deleting a project removes all of its training runs from Luna Studio. **Registered metrics** are
  not affected — they remain in the [Galileo metrics store](/concepts/metrics/overview) until you
  delete them there.
</Warning>
