...
You see **Invalid email or password** on the [Sign in](/luna-studio/account/sign-in) page.

| Likely cause          | What to try                                                                        |
| --------------------- | ---------------------------------------------------------------------------------- |
| Wrong password        | Click [Forgot your password?](/luna-studio/account/forgot-password) to reset it.               |
| Account doesn't exist | Click **Create account** at the bottom of the form to [Sign up](/luna-studio/account/sign-up). |
...
| Wrong email      | Go back to [Forgot password](/luna-studio/account/forgot-password) and re-enter.   |
...
The [Run details](/luna-studio/runs/run-details) page shows a destructive **Run failed** alert.
...
| Auth session expired | Refreshing routes you to [Sign in](/luna-studio/account/sign-in). |
