...
- An instance of Luna Studio deployed for your org (Luna Studio is part of the enterprise tier &mdash; see [Availability and deployment](/luna-studio/availability)).
...
<Tip>Don't have a labelled training dataset yet? Luna Studio can **generate a training set** from your test set — see the [training-set step below](#step-6-add-a-training-set). The test set still needs enough labelled rows for reliable evaluation.</Tip>
...
- **Use existing training set** — reuse a training dataset that already exists in your workspace.
  ...
  <Frame caption="New run, Step 3 — generate, add, or reuse a training set">![Training set step](/images/luna-studio/runs/new-run-training-set.png)</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Luna Studio deep dive" icon="wand-magic-sparkles" href="/luna-studio/runs/new-run/overview">
