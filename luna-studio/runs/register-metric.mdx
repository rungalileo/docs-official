...
Once a run reaches **Fine-tuned**, you can register the resulting metric. Registration publishes the metric to the [Galileo metrics store](/concepts/metrics/overview), where it becomes available across the Galileo platform — for evaluation in experiments, logstreams, and runtime guardrails using Protect / Agent Control.
