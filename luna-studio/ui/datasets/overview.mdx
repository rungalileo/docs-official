...
The **Datasets** page (sidebar → **Datasets**) is where you manage every dataset in your organization. Datasets are organization-wide — once added, they are available across every project for any training run.
