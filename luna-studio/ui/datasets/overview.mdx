...
- **Add test set / Add training set** &mdash; primary button. The label tracks the active tab. Opens the **Add dataset** modal — see [Add a dataset](/luna-studio/ui/datasets/add-a-dataset).
