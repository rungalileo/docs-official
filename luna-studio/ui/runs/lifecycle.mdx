...
Every training run in Luna Studio progresses through a small state machine. The same statuses are reused on the [Metrics](/luna-studio/ui/metrics/overview) page, since each run produces exactly one metric.
