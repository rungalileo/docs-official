...
The labelled training set must contain at least 2,000 rows total and at least 100 examples per class. If you fetch from private object storage, use a presigned HTTPS URL; raw `s3://` and `gs://` URIs are not supported.
