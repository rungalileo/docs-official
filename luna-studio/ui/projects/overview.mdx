...
- **New project** &mdash; primary button on the right. Opens the create project modal.
...
- Datasets are workspace-wide and can be reused across projects. LLM provider integrations can come from a personal override or an administrator-managed workspace default.
