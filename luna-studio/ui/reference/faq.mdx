...
<Accordion title="Who is it for?">
  Data Scientists, ML and AI engineers who need evaluation metrics tailored to a specific domain (legal, healthcare, RAG over internal docs, etc.). If you prefer a simple / easy version, choose the UI. If you prefer more control and wish to
  use your own infra, choose the SDK{" "}
</Accordion>
...
<Accordion title="How big should my test set be?">
  Ideally a test should consist of 1000-3000 samples with a good distribution across the classes. We enfornce a min of 300 human-labelled rows with min of 100 samples per class, since quality is more important then quantity, and human labelling isn't cheap.
</Accordion>
