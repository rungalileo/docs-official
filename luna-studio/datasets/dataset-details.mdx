...
<Frame caption="Dataset details for a single test set, with row preview and validation status">
  ![Dataset details page](/images/luna-studio/datasets/dataset-details.png)
</Frame>
