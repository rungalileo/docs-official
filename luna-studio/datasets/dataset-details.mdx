...
The center renders a paginated preview of the dataset:
...
Use the pagination controls to move through available preview pages.
...
| Source          | Source cell (icon + label, e.g. "Upload" / "URL" / "Galileo"). | Source cell for the training set, such as generated, upload, URL, or Galileo.                                                                             |
...
| Runs            | (Not shown for test sets in this iteration.)                   | Run references when available.                                                                                                                            |
