...
The resulting dataset shows up on the [Datasets page](/luna-studio/datasets/overview) with source **Generated** and a subtitle like "Generated from rag-eval-v2". Each row carries an **Origin** marker so you can trace it back: rows synthesized by the generator render as "Generated", while rows seeded from a test set render as a chip with that test set's name.
